...
namespace Ecommerce_p1.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailId,Quantity,UnitPrice,ProductId,OrderId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailId,Quantity,UnitPrice,ProductId,OrderId")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
